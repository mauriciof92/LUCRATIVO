...
exports.runTriggerEngineTests = runTriggerEngineTests;
...
function runTriggerEngineTests() {
    ...
    const matchInput1 = (0, trigger_adapter_1.gameToMatchInput)(mockGame);
    console.log('MatchInput:', JSON.stringify(matchInput1, null, 2));
    const evaluations1 = (0, trigger_engine_1.evaluateAllMarkets)(matchInput1);
    console.log('\nAvaliações:');
    ...
    console.log('\n📊 Teste 2: Jogo CSV apenas (csv_only)');
    const matchInput2 = (0, trigger_adapter_1.gameToMatchInput)(mockGameCsvOnly);
    console.log('MatchInput:', JSON.stringify(matchInput2, null, 2));
    const evaluations2 = (0, trigger_engine_1.evaluateAllMarkets)(matchInput2);
    console.log('\nAvaliações:');
    ...
    Object.entries(trigger_engine_1.TRIGGER_CONFIGS).forEach(([marketId, config]) => {
    ...
    for (let i = 0; i < 1000; i++) {
        (0, trigger_engine_1.evaluateAllMarkets)(matchInput1);
    }
    ...
    const matchInputEmpty = (0, trigger_adapter_1.gameToMatchInput)(emptyGame);
    const evaluationsEmpty = (0, trigger_engine_1.evaluateAllMarkets)(matchInputEmpty);
